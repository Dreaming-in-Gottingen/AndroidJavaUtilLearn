...
public class MainActivity extends Activity {
    private static final String TAG = "Camera1Test";
    ...
    public void selectCameraDeviceId(View v) {
        Log.d(TAG, "select which CamId for preview! front or back for Camera1");
        if (mCamDevCnt == 0) {
            if (mCamHelper == null) {
        ...
        mCamDevCnt = CameraHelper.getCameraDeviceCount();
        String[] items = new String[mCamDevCnt];
        int idx = 0;
        for (; idx<mCamDevCnt; idx++) {
            items[idx] = "camId" + idx + (idx==0?":back":":front");
        }
        ...
        alert.setSingleChoiceItems(items, mCurCamId, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Log.d(TAG, "touch for select idx=" + i);
                mCurCamId = i;
            }
        });
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCurCamState == 0) {
                    ...
                    Log.d(TAG, "start camera device and preview!");
                    mCamHelper.openCameraAndStartPreview(mCurCamId);
                    mCamHelper.updatePreview();
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCurCamState == 1) {
                    ...
                    mCamHelper.closeCameraAndStopPreview();
                    mCurCamState = 0;
                    button3.setText("state:" + mCurCamState);
                }
            }
